...
import com.microservice.fastfooddelivery.service.CatalogoService;
...
public class CatalogoController {
    ...
    public ResponseEntity<CatalogoDTO> crear(@Valid @RequestBody Catalogo catalogo) {
        return new ResponseEntity<>(catalogoService.guardarCatalogoDTO(catalogo), HttpStatus.CREATED);
   
    }

    @PutMapping("/{id}")
    public ResponseEntity<CatalogoDTO> actualizar(@PathVariable Integer id, @RequestBody Catalogo catalogo) {
        return new ResponseEntity<>(catalogoService.actualizarCatalogoDTO(id, catalogo), HttpStatus.OK);
    }
