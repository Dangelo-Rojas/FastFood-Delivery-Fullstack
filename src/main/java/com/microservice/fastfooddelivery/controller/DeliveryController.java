...
import com.microservice.fastfooddelivery.service.DeliveryService;
...
public class DeliveryController {
    ...
    public ResponseEntity<List<DeliveryDTO>> obtenerPorEstado(@PathVariable String estado) {
        ...
        return new ResponseEntity<>(deliveryService.obtenerPorEstado(estado), HttpStatus.NO_CONTENT);
    }

    @GetMapping("/conductor/{idConductor}")
    public ResponseEntity<List<DeliveryDTO>> obtenerPorConductor(@PathVariable Long idConductor) {
        return new ResponseEntity<>(deliveryService.obtenerPorConductor(idConductor), HttpStatus.NO_CONTENT);
    }
