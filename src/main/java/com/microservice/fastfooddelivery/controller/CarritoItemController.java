...
import com.microservice.fastfooddelivery.service.CarritoItemService;
...
public class CarritoItemController {
    ...
    public ResponseEntity<List<CarritoItemDTO>> obtenerPorCarrito(@PathVariable Integer idCarrito) {
        return new ResponseEntity<>(carritoItemService.obtenerPorCarrito(idCarrito), HttpStatus.NO_CONTENT);
    }
