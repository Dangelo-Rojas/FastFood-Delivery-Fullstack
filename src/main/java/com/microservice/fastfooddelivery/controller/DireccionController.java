...
public class DireccionController {
    ...
    public ResponseEntity<List<DireccionDTO>> obtenerTodas() {
        return new ResponseEntity<>(direccionService.obtenerTodas(), HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<List<DireccionDTO>> obtenerPorUsuario(@PathVariable Long idUsuario) {
        return new ResponseEntity<>(direccionService.obtenerPorUsuario(idUsuario),HttpStatus.NO_CONTENT);
    }
