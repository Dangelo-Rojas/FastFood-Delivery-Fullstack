...
public class RestauranteController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Restaurante> editarRestaurante(@PathVariable Integer id, @RequestBody Restaurante restaurante) {
        try {
            Restaurante editado = restauranteService.guardarRestaurante(restaurante);
    ...
    public ResponseEntity<Restaurante> actualizarRestaurante(@PathVariable Integer id, @RequestBody Restaurante restaurante){
        try{
            Restaurante newRestaurante = restauranteService.actualizarRestaurante(id, restaurante);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> eliminarRestaurante(@PathVariable Integer id) {
        String resultado = restauranteService.eliminar(id);
